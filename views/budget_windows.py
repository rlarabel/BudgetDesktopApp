...
def edit_account_win(sg, account_info, menu):
    ...
    window = sg.Window('Edit/Delete Account', layout, keep_on_top=True, finalize=True, icon=ICON)
...
def create_account_win(sg):
    ...
    window = sg.Window('Add Account', layout, keep_on_top=True, finalize=True, icon=ICON)
...
def edit_category_win(sg, category_info, acc_menu, cat_menu):
    ...
    window = sg.Window('Edit/Delete Category', layout, keep_on_top=True, finalize=True, icon=ICON)
...
def create_category_win(sg, menu):
    ...
    window = sg.Window('Add Category', layout, keep_on_top=True, finalize=True, icon=ICON)
...
def move_funds_win(sg, menu):
    ...
    window = sg.Window('Budget Funds Transaction', layout, keep_on_top=True, finalize=True, icon=ICON)
    return window
